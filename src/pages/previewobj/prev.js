          ...
          <div className="de">
            <div className="den">
              ...
              <div className="switch">
                ...
                <input type="radio" checked={scaleFactor === 0.5} onChange={() => handleButtonClick(0.5)} name="switch" id="switch_off" />
                <input type="radio" checked={scaleFactor === 1} onChange={() => handleButtonClick(1)} name="switch" id="switch_1" />
                <input type="radio" checked={scaleFactor === 1.5} onChange={() => handleButtonClick(1.5)} name="switch" id="switch_2" />
                <input type="radio" checked={scaleFactor === 2} onChange={() => handleButtonClick(2)} name="switch" id="switch_3" />
                <input type="radio" checked={scaleFactor === 2.5} onChange={() => handleButtonClick(2.5)} name="switch" id="switch_4" />
                <input type="radio" checked={scaleFactor === 3} onChange={() => handleButtonClick(3)} name="switch" id="switch_5" />
